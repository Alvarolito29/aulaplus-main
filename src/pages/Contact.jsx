        ...
        if(errs.length === 0) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    setErrors(['Error al enviar el mensaje. Por favor intenta nuevamente.']);
                }
            } catch (error) {
                console.error('Error:', error);
                setErrors([`Error de conexión: ${error.message}`]);
            } finally {
                setLoading(false);
            }
        }
                            ...
                            <Card.Body style={{ padding: '40px', background: '#fff' }}>
                                ...
                                <Form onSubmit={onSubmit} noValidate>
                                    ...
                                    <Form.Group className="mb-4" controlId="telefono">
                                        ...
                                        <Form.Text muted>Déjanos tu número si prefieres que te llamemos.</Form.Text>
                                    </Form.Group>
